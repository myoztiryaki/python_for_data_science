...
# ?print # fonksiyonun ne işe yaradığını açıklıyor yanlış kullanım sonrası.
# Docstring:
...
# console dan help(print) yazarak da bu kısma ulaşılabilir.
