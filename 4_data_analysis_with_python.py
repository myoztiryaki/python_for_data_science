...
#############################################
# Apply ve Lambda
"""Apply satır veya sutunlarda otomatik olarak fonksiyon çalıştırmayı sağlar
Lambda ise bir fonksiyon tanımlama şeklidir tıpkı def gibi farkı kullan at fonksiyon """
#############################################
import pandas as pd
import seaborn as sns
pd.set_option('display.max_columns', None)
...
plt.boxplot(df["fare"])   #booking bu tarz görseli soruyor mülakatta
plt.show()
